...
public class RemoteControlApp {
	...
	/*
	 * Overview We are going to simulate a remote control. It will have buttons "0"
	...
	public static void main(String[] args) {
		...
		while (!userInput.equals("on")) {		//while loop will continue to loop until user inputs "on"
			System.out.println("Please Turn ON Remote To Use Features");
			userInput = keyboard.next().toLowerCase();
		}
		turningON(); // tells program to go to method "turningON()"
	...
	public static void inputNum() {
		...
		case "8":
		case "9":
			pressButton(); // sends program back to method "pressButton()" BOOP!
			break;
		case "off":
			turningOff();
			break;
